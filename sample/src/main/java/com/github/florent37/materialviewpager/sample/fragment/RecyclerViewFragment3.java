...
public class RecyclerViewFragment3 extends Fragment {
    ...
    public static RecyclerViewFragment3 newInstance() {  return new RecyclerViewFragment3();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_recyclerview3, container, false);
    }
